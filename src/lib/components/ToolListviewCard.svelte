<script lang="ts">
	...
	function navigateToTool() {
		window.location.href = `${base}/${tool.slug}/`;
	}
...
<div class="p-4">
	<div
		role="link"
		tabindex="0"
		on:click={navigateToTool}
		on:keydown={handleKeydown}
		class="card-wrapper w-full flex flex-col justify-center lg:flex-row lg:justify-between items-center bg-base-100 shadow-xl cursor-pointer"
	>
		<!-- Tool Icon & Details -->
		<div
